...
extension OrderStatusMatch on OrderStatus {
  T match<T>(
      ...
      required T Function() confirmRemoveProducts,
    ...
    if (v == OrderStatus.confirmRemoveProducts) {
      return confirmRemoveProducts();
    }
  ...
  T matchAny<T>(
      ...
      T Function()? confirmRemoveProducts,
      T Function()? emptyBag,
      T Function()? success}) {
    final v = this;
